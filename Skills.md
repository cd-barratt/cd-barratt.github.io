## Skills
I am independent and able to plan and manage own workload as well as managing and developing junior staff. I am competent in conceiving, acquiring funding and executing/managing projects to ensure that objectives and deadlines are met to provide highest quality outputs and reporting for relevant stakeholders. I am able to lead projects and initiatives that are supportive to upper management to improve workflows and efficiency 

On a technical level I am trained in frequentist and Bayesian statistics and have strong analytical and technical skills (including configuring environments for parallelisation via HPC). I like to keep up to date with things so I regularly attend courses and workshops to stay at the leading edge of analytical and conceptual advancements. For brevity I will not list all the tools I use, but here are some examples of the kinds of software tools/packages that I use regularly in my work (mostly in R, bash and python):

* Genomic data processing/filtering - Stacks, iPyrad, dDocent, ANGSD, snpAD, GATK, FastQC, VCFtools, snpeff
* eDNA metabarcoding - QIIME2, Dorado, Decona
